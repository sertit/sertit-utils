<%!
    # Template configuration. Copy over in your doc_template directory
    # (used with `--doc_template-dir`) and adapt as necessary.
    ...
    # according to this doc_template. Supported keywords for interpolation
